...
public class GameManager : MonoBehaviour
{
    ...
    const string FILE_SCORES = DIR_LOGS + "/highScore.txt";     // Logs//highScore.txt"
    const string FILE_ALL_SCORES = DIR_LOGS + "/allScores.csv"; // Logs//allScores.csv
    ...
    public int Score
    {
        ...
        set
        {
            score = value; //value = current value
    ...
    void Awake()
    {
        ...
        {
            //if the scene load, but this one will be kept
